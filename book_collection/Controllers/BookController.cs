...
namespace book_collection.Controllers
{
    public class BookController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Author,CategoryId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Author,CategoryId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
